...
const Index = () => {
  ...
  const skills = ["JavaScript/TypeScript", "React/Vue/Angular", "Node.js/Express", "Python/Django", "Database Design", "Cloud Architecture", "DevOps/CI/CD", "Machine Learning", "Blockchain Development"];
          ...
          <div className="grid md:grid-cols-2 gap-12 items-center">
            ...
            <div className="glass-card p-8">
              ...
              <div className="grid grid-cols-2 gap-3">
                {skills.map(skill => <div key={skill} className="skill-tag">
      ...
      <section id="projects" className="py-20 relative">
        <div className="container mx-auto px-6">
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-2 gap-8">
            {projects.map((project, index) => <div key={index} className="project-card glass-card overflow-hidden group">
