...
const Index = () => {
  ...
  const skills = [
    ...
    "Database Design", "Cloud Architecture", "DevOps/CI/CD", "Machine Learning", "Blockchain Development"
  ];
      ...
      <section id="home" className="hero-section min-h-screen flex items-center justify-center relative overflow-hidden">
        ...
        <div className="container mx-auto px-6 text-center relative z-10">
          <div className="avatar-container mb-8">
            <div className="w-32 h-32 mx-auto rounded-full bg-gradient-to-r from-cyan-400 to-purple-500 p-1 animate-pulse-glow overflow-hidden">
              <img 
                src="https://images.unsplash.com/photo-1472099645785-5658abf4ff4e?w=150&h=150&fit=crop&crop=face" 
                alt="Siva Sai Ruthvik Goli - Professional Portrait"
                className="w-full h-full rounded-full object-cover"
              />
            </div>
          </div>
          <h1 className="text-5xl font-bold mb-6 bg-gradient-to-r from-cyan-400 via-purple-500 to-pink-500 bg-clip-text text-transparent animate-fade-in md:text-7xl">
            Siva Sai Ruthvik Goli
          </h1>
          <p className="text-xl md:text-2xl text-gray-300 mb-8 animate-fade-in-delay">
            Crafting Code with a Creative Soul
          </p>
            ...
            <div className="glass-card p-8">
              <div className="mb-6">
                <img 
                  ...
                  alt="Siva Sai Ruthvik Goli - Professional Photo"
                  className="w-48 h-64 rounded-lg object-cover mx-auto border-2 border-cyan-400/30 shadow-lg shadow-cyan-400/20"
                />
              </div>
